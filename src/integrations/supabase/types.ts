  ...
  public: {
    Tables: {
      ...
      catalog_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "catalog_items_workshop_id_fkey"
            columns: ["workshop_id"]
            isOneToOne: false
            referencedRelation: "workshops"
            referencedColumns: ["id"]
      ...
      kanban_automations: {
        ...
        Relationships: [
          {
            foreignKeyName: "kanban_automations_column_id_fkey"
            columns: ["column_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "kanban_automations_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
      ...
      kanban_columns: {
        ...
        Relationships: [
          {
            foreignKeyName: "kanban_columns_workshop_id_fkey"
            columns: ["workshop_id"]
            isOneToOne: false
            referencedRelation: "workshops"
            referencedColumns: ["id"]
      ...
      message_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "message_templates_workshop_id_fkey"
            columns: ["workshop_id"]
            isOneToOne: false
            referencedRelation: "workshops"
            referencedColumns: ["id"]
      ...
      order_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "order_history_from_column_id_fkey"
          ...
          {
            foreignKeyName: "order_history_to_column_id_fkey"
      ...
      workshop_settings: {
        Row: {
          address_header: string | null
          created_at: string
          id: string
          logo_url: string | null
          phone_header: string | null
          updated_at: string
          whaticket_connected: boolean | null
          whaticket_url: string | null
          workshop_id: string
        }
        Insert: {
